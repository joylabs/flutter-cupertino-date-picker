...
class _DateTimePickerWidgetState extends State<DateTimePickerWidget> {
  DateTime _minTime = DateTime.now(), _maxTime = DateTime.now();
  ...
  _DateTimePickerWidgetState(
    ...
    _secondScrollCtrl =
        FixedExtentScrollController(initialItem: _currSecond! - _secondRange!.first);
  ...
  void _onPressedConfirm() {
    if (widget.onConfirm != null) {
      ...
      DateTime dateTime =
          DateTime(day.year, day.month, day.day, _currHour!, _currMinute!, _currSecond!);
  ...
  Widget _renderDatePickerWidget() {
    ...
    List<String> formatArr =
        DateTimeFormatter.splitDateFormat(widget.dateFormat, mode: DateTimePickerMode.datetime);
